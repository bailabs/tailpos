                ...
                [
                    {
                        ...
                        onPress: () => {
                            ...
                            if (
                                 props.receiptStore.defaultReceipt.orderType !== "None"
                            ) {
                             ...
                             props.shiftStore.defaultShift.addTotalSales(
                                totalAmountDue,
                            );
                             props.receiptStore.defaultReceipt.lines.map(val => {
                                totalPurchase =
                            ...
                            props.receiptStore.add(
                                 props.receiptStore.defaultReceipt,
                            );
                             props.receiptStore.setPreviousReceipt(
                                 props.receiptStore.defaultReceipt,
                            );
                            let discountValueForDisplay =  props.receiptStore
                                .defaultReceipt.discounts;
                            let taxesValueForDisplay =  props.stateStore
                                .enableOverallTax
                                ?  props.receiptStore.defaultReceipt.get_tax_total
                                :  props.receiptStore.defaultReceipt
                                    .get_tax_total_based_on_each_item;
                            ...
                            change_navigation(props,totalPurchase, discountValueForDisplay,taxesValueForDisplay);
                            ...
                            if (res) {
                                ...
                                for (
                                    ...
                                    writePromises.push(
                                        BluetoothSerial.write(
                                            TinyPOS.bufferedText(
                                                strings.Cashier +
                                                `${
                                                     props.attendantStore.defaultAttendant
                                                        .user_name
                                                    }`,
                                    ...
                                    let sub = formatNumber(
                                        parseFloat(
                                             props.receiptStore.defaultReceipt.subtotal,
                                            10,
                                        ),
                                    ).toString();
...
export function change_navigation(props,totalPurchase, discountValueForDisplay,taxesValueForDisplay){
