...
export default class PaymentContainer extends React.Component {
    ...
    async onPay() {
        if (this.props.stateStore.payment_state[0].value) {
                        ...
                        [
                            {
                                ...
                                onPress: () => {
                                    ...
                                    this.props.receiptStore.defaultReceipt.lines.map(val => {
                                        ...
                                        defaultShift.addCommission(parseInt(val.commission_amount, 10));
                                    ...
                                    this.props.shiftStore.defaultShift.addTotalSales(totalAmountDue);
                                    this.props.receiptStore.defaultReceipt.lines.map(val => {
                                        totalPurchase =
            ...
            Alert.alert("Alert", "Please Enter valid Amount");
        }
    }
    ...
    render() {
        return (
            <PaymentScreen
                ...
                defaultCustomer={this.props.receiptStore.defaultCustomer.name.toString() ? this.props.receiptStore.defaultCustomer.name.toString() : "Default customer" }
                onPay={() => this.onPay()}
