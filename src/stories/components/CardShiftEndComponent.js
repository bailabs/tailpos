                        ...
                        <View style={{ flex: 1, flexDirection: "row", marginTop: 15 }}>
                            <Button
                                ...
                                onPress={() => {
                                    ...
                                    this.props.payInClick({pay: this.props.pay, reason: this.state.reason, type: "Pay In"});
                                }}
                                style={payInStyle}
                            >
                                <Text>Pay-in</Text>
                            ...
                            <Button
                                ...
                                onPress={() => {
                                    this.setState({ pay: "",reason: "" });
                                    this.props.payOutClick({pay: this.props.pay, reason: this.state.reason, type: "Pay Out"});
                                }}
                                style={payOutStyle}
                            >
                                <Text>Pay-out</Text>
